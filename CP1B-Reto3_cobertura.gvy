pipeline {
    ...
    stages {
        stage('Get Code') {
            ...
            steps {
                git branch: 'feature_fix_coverage', url: 'https://github.com/FrankyGA/PracticaHelloWorld-CP1B.git'
                bat 'dir'
                bat 'whoami'
                bat 'hostname'
                ...
                script {
                    ...
                    catchError(buildResult: 'UNSTABLE', stageResult: 'FAILURE') {
                        cobertura coberturaReportFile: 'coverage.xml', 
                                  conditionalCoverageTargets: '100,0,100',  // Ajusta estos valores según sea necesario
                                  lineCoverageTargets: '100,0,100'
                    }
                }
            }
        }

...
#Ruta principal de acceso a la calculadora
...
def divide(op_1, op_2):
    try:
        num_1, num_2 = util.convert_to_number(op_1), util.convert_to_number(op_2)
        #Para controlar el error de la división entre 0
        if num_2 == 0:
            return ("Division by zero is not possible", http.client.NOT_ACCEPTABLE, HEADERS)
